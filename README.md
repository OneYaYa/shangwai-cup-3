...
- 本场团队关卡分 = 道中追猎、特殊关卡与一般关卡的有效奖励，不乘个人倍率；需要队内唯一的项目按已录入选手的赛程顺序去重。
- 团队总加分 = 各场团队关卡分之和 + 首次结局奖励。
- 团队总分 = 选手结算分合计 + 团队总加分。

特别加分包括机械师、抓位、文明开化补偿、沙盘、三供无削、限制奖励、竞技结局奖励与箱中猎影；这些项目均进入选手结算公式并参与个人倍率。团队关卡分只包括道中追猎、特殊关卡与一般关卡奖励。每场结算分和团队关卡贡献分别保留两位小数后相加，确保展示账目与总分一致。未填写结算分的记录不参与团队统计。
...
竞技团队数据视图按队伍汇总结算录入、结局完成、全追猎、额外重开、连麦、超取权、剩余存款、Boss 最高个人特别加分记录与首通归属，以及队内唯一的道中追猎和特殊关卡。各项数据由选手记录自动计算，并可从团队视图返回对应选手继续编辑。

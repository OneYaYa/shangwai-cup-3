...
window.CUP = {
  ...
  players:[
    ...
    {id:'mumu',name:'缪缪厨一号',track:'competitive',squad:'破坏战术分队',difficulty:'N15',date:'2026-09-20',time:'19:30',team:'teddy',row:2},
    {id:'duck',name:'一只大鸭鸭',track:'competitive',squad:'破坏战术分队',difficulty:'N15',date:'2026-09-21',time:'21:30',team:'duck',row:3},
    ...
    {id:'cheng',name:'涩一',track:'competitive',squad:'远程战术分队',difficulty:'N15',date:'2026-09-25',time:'14:00',team:'teddy',row:6},
    {id:'bridge',name:'路南桥',track:'competitive',squad:'远程战术分队',difficulty:'N15',date:'2026-09-25',time:'19:30',team:'duck',row:7},
    {id:'narrative',name:'narrative',track:'competitive',squad:'突击战术分队',difficulty:'N15',date:'2026-09-26',time:'21:30',team:'duck',pressure:true,row:8},
  ...
  squads:[['other','其余分队 · ×1.00',1],['trade','多边贸易分队 · ×0.85',.85],['civil','文明开化分队 · ×1.10',1.1],['ground','地面突破分队 · ×1.10',1.1],['high','高台突破分队 · ×1.10',1.1],['assault','突击战术分队· ×1.00',1],['destruction','破坏战术分队· ×1.00',1],['fortress','堡垒战术分队 · ×1.00',1],['ranged','远程战术分队· ×1.00',1]],
